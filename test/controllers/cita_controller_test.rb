...
class CitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post cita_url, params: { citum: { Apellido: @citum.Apellido, Diagnostico: @citum.Diagnostico, Edad: @citum.Edad, Name: @citum.Name, Notas: @citum.Notas } }
    end
  ...
  test "should update citum" do
    patch citum_url(@citum), params: { citum: { Apellido: @citum.Apellido, Diagnostico: @citum.Diagnostico, Edad: @citum.Edad, Name: @citum.Name, Notas: @citum.Notas } }
